...
> ⚠️ **هشدار مهم:** این ابزار برای اتک ساخته شده و به هیچ عنوان لیمیتش بیشتر نکنید. این ابزار بسیار خطرناک هستش.  
> به عنوان شوخی خوبه ولی بهترین کارکردش برای نابود کردن - کرش کردن یا هر چیز دیگه است.  
> از دست کاری لیمیت تایمی و لیمیت قدرت بپرهیزید.

**قابلیت‌های ابزار:** API800-Call400API بله این قدر این ابزاره
...
برای نصب تمام کتابخانه‌های مورد نیاز، دستور زیر را در CMD یا ترمینال اجرا کنید:
